...
pub fn translate(str: &str) -> &str {
    match str {
        ...
        "commands.spreadplayers.spreading.players" => {
            "Spreading {} player(s) {} blocks around {}, {} (min {} blocks apart)"
        }
        "commands.spreadplayers.info.players" => {
            "(Average distance between players is {} blocks apart after {} iterations)"
        }
        ...
        "commands.worldborder.setSlowly.grow.success" => {
            "Growing world border to {} blocks wide (up from {} blocks) over {} seconds"
        }
        "commands.worldborder.setSlowly.shrink.success" => {
            "Shrinking world border to {} blocks wide (down from {} blocks) over {} seconds"
        }
        "commands.worldborder.center.success" => "Set world border center to {}, {}",
        "commands.worldborder.damage.buffer.success" => {
            "Set world border damage buffer to {} blocks (from {} blocks)"
        }
        "commands.worldborder.damage.amount.success" => {
            "Set world border damage amount to {} per block (from {} per block}"
        }
        "commands.worldborder.warning.time.success" => {
            "Set world border warning to {} seconds away (from {} seconds)"
        }
        "commands.worldborder.warning.distance.success" => {
            "Set world border warning to {} blocks away (from {} blocks)"
        }
        ...
        "commands.scoreboard.players.remove.usage" => {
            "/scoreboard players remove <player> <objective>"
        }
        ...
        "commands.scoreboard.teams.leave.failure" => {
            "Could not remove {} player(s) from their teams: {}"
        }
        ...
        "commands.advancement.revoke.through.success" => {
            "Revoked '{}', all ancestors and all descendants ({} total revoked) from {}"
        }
        "commands.advancement.revoke.everything.success" => {
            "Revoked every advancement ({} total revoked) from {}"
        }
        "commands.advancement.revoke.from.success" => {
            "Revoked '{}' and all descendants ({} total revoked) from {}"
        }
        "commands.advancement.revoke.from.failed" => {
            "Couln't revoke the advancement '{}' or its descendants from {} because they haven't started any"
        }
        "commands.advancement.revoke.only.success" => "Revoked the entire advancement '{}' from {}",
        "commands.advancement.revoke.only.failed" => {
            "Couldn't revoke the advancement '{}' from {} because they haven't started it"
        }

        "commands.advancement.grant.only.success" => "Granted the entire advancement '{}' to {}",
        "commands.advancement.grant.only.failed" => {
            "Couldn't grant the advancement '{}' to {} because they already have it"
        }
        "commands.advancement.grant.from.success" => {
            "Granted '{}' and all descendants ({} total granted) to {}"
        }
        "commands.advancement.grant.from.failed" => {
            "Couldn't grant the advancement '{}' or its descendants to {} because they already have them all"
        }
        "commands.advancement.grant.everything.success" => {
            "Granted every advancement ({} total granted) to {}"
        }
        "commands.advancement.grant.everything.failed" => {
            "Couldn't grant any advancements to {} because they already have them all"
        }

        "commands.advancement.grant.many.to.one.success" => "Granted {} advancements to {}",
        "commands.advancement.grant.one.to.many.success" => {
            "Granted the advancement {} to {} players"
        }
        ...
        "commands.generic.player.unspecified" => {
        ...
        "argument.player.entities" => {
            "Only players may be affected by this command. provided selector includes entities"
        }
        ...
        "commands.generic.num.tooBig" => {
            "The number you have entered ({}) is too big, it must be at most {}"
        }
