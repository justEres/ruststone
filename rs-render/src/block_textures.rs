...
impl AtlasBlockMapping {
    ...
    pub fn texture_index_for_state(&self, block_state: u16, face: Face) -> u16 {
        ...
        let override_name: Option<&'static str> = match block_id {
            ...
            108 => Some("brick.png"),
            109 => Some("stonebrick.png"),
            114 => Some("nether_brick.png"),
            128 => Some("sandstone_normal.png"),
            134 => Some("planks_spruce.png"),
            135 => Some("planks_birch.png"),
            136 => Some("planks_jungle.png"),
            156 => Some("quartz_block_side.png"),
            163 => Some("planks_acacia.png"),
            164 => Some("planks_big_oak.png"),
            180 => Some("red_sandstone_normal.png"),
