...
const SETTINGS: &[SettingEntry] = &[
    ...
    SettingEntry { id: SettingId::VoxelAoFoliageBoost, title: "Foliage/cutout AO boost", category: SettingsCategory::Lighting, aliases: &["leaf ao", "foliage ao", "cutout foliage ao"], visible: always },
...
fn render_setting_row(
    ...
    match id {
        ...
        SettingId::VoxelAoFoliageBoost => ui.add(egui::Slider::new(&mut render_debug.voxel_ao_foliage_boost, 0.5..=4.).text("Foliage/cutout AO boost")).changed(),
